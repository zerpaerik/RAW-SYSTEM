        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a onclick="redireccionar('/organismos/create');"  class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Organismos</a>
                    </li>
                    <li>
                        <a href="chart.html" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i>Dependencias</a>
                    </li>
                    <li>
